...
namespace LightspeedAccess.Models.Order
{
	...
	public class OrderList2: IPaginatedResponse
	{
		[ XmlElement( typeof( LightspeedOrder2 ) ) ]
		public LightspeedOrder2[] Sale{ get; set; }
		...
		{
			var otherTyped = ( OrderList2 )other;
			if( otherTyped != null )
			{
