...
{
	public class GetSalesRequest2: LightspeedRequest, IRequestPagination
	{
		...
		public GetSalesRequest2( DateTime fromDateUtc, DateTime toDateUtc, int offset = 0, int limit = 50 )
		{
			this.Limit = limit;
			this.Offset = offset;
